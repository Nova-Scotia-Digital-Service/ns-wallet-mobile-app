...
const translation = {
  ...
  "Biometry": {
    ...
    "EnabledText1Bold": "you will need to use biometrics to open your NS Wallet. (FR)",
    "EnabledText2": "This means all fingerprint and facial data added on this phone can be used to access your NS Wallet. (FR)",
    "EnabledText3": "Anyone who can access your phone with biometrics can access your NS Wallet. (FR)",
  ...
  "Settings": {
    ...
    "HelpUsingBCWallet": "Help using NS Wallet (FR)",

      ...
      <ScrollView style={{ padding: 20 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <Text style={[defaultStyle.bodyText, { marginTop: 25 }]}>
            You approve every use of information from your NS Wallet. You also only share what is needed for a
            situation.
            {'\n\n'}
            The Government of Nova Scotia is not told when you use your digital credentials.
          </Text>
        </View>
      </ScrollView>
...
const StartPages = (theme: Theme) => {
  ...
  return (
    <ScrollView style={{ padding: 20, paddingTop: 30 }}>
      ...
      <Text style={[defaultStyle.bodyText, { marginTop: 25 }]}>
        NS Wallet lets you receive, store and use digital credentials.
      </Text>
      <Text style={[defaultStyle.bodyText, { marginTop: 25 }]}>
        It is highly secure, and helps protect your privacy online.
      </Text>
      <Text style={[defaultStyle.bodyText, { marginTop: 25 }]}>
        NS Wallet is currently in its early stages and the technology is being explored. Most people will not have a use
        for NS Wallet yet, because very few digital credentials are available.
      </Text>
    </ScrollView>
  )
}
...
const guides: Array<{
...
}> = [
  {
    ...
    body: 'NS Wallet holds digital credentials—the digital versions of things like licenses, identities and permits.\n\nThey are stored securely, only on this device.',
  },
  {
    image: ScanShare,
